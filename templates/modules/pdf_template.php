...
<body>
  ...
  <table width="100%">
    <tr>
      <td valign="top"><img src="<?php echo IMG.'logo.png'; ?>" alt="logoempresa" width="150"/></td>
      <td align="right">
        <h2 style="color:red">Cotización # <?php echo $d->number;?></h2>
  ...
  <table width="100%">
    <tr>
      <td><strong>De:</strong> Tony - FapCod</td>
